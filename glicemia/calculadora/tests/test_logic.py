...
@unittest.skip("Pendiente: crear una función de servicio real para evaluar la lógica clínica.")
class EvaluarGlicemiaTests(SimpleTestCase):
    ...
    def test_hiperglucemia_sostenida_si_actual_y_previa_mayor_o_igual_180_sin_infusion(self):
        pass
